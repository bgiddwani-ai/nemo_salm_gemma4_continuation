...
```bash
git clone https://github.com/bgiddwani-ai/nemo_salm_gemma4_continuation.git
cd nemo_salm_gemma4_continuation
docker run --gpus all -it --ipc=host -v $PWD:/home/salm -p 8000:8000 nvcr.io/nvidia/pytorch:25.11-py3
```
